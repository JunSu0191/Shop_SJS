	...
	<div class="container shop">
		...
		<form name="product" action="update_pro.jsp" onsubmit="return checkProduct()" method="post" enctype="multipart/form-data">
			...
			<div class="input-group mb-3 row">
				...
				<input type="file" class="form-control col-md-10" name="file" value="<%= product.getFile() %>">
			</div>	
		
			<div class="input-group mb-3 row">
				<label class="input-group-text col-md-2" id="">상품 코드</label>
				<input type="text" class="form-control col-md-10" name="productId" required value="<%= product.getProductId() %>">
			</div>
			
			<div class="input-group mb-3 row">
				<label class="input-group-text col-md-2" id="">상품명</label>
				<input type="text" class="form-control col-md-10" name="name" required value="<%= product.getName()%>">
			</div>
